...
public class VNuevaTendencia extends Panel implements View {
	...
	private VerticalLayout buildMainLayout() {
		...
		mainLayout
				.addComponent(SeleccionPlebiscito);
		...
		mainLayout.addComponent(BotonNueva);
		...
		mainLayout.addComponent(EtiquetaCrearNueva);
		...
		mainLayout.addComponent(SeleccionTendencia);
