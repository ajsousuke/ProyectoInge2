...
public class VRegistrarPadron extends CustomComponent implements Window.CloseListener, View{
	...
	public VRegistrarPadron(final RegistrarPadron controlador) {
		...
		btn_Agregar.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if((textField_1.getValue().length() == 9) && (datos.length == 3)){
	...
	private GridLayout buildGridLayout_2() {
		...
		gridLayout_2.addComponent(lbl_Nombre, 0, 1);
		gridLayout_2.setComponentAlignment(lbl_Nombre, new Alignment(33));
		...
		textField_2.setNullSettingAllowed(true);
		gridLayout_2.addComponent(textField_2, 1, 1);
		...
		gridLayout_2.addComponent(btn_Agregar, 4, 1);
	...
	private GridLayout buildGridLayout_3() {
		...
		gridLayout_3.setComponentAlignment(btn_Editar, new Alignment(6));
